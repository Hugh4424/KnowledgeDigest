...
- T013: run_id=`run-6827d359b90d467c87d3d955d4a6673d`; evidence=`apply/evidence/T013.semantic-run-task1-repair-20260812.json`; evidence sha256=`dd3e746c44edab76500259a61abbca3f97f8a2dcec83ebbbf5356e01d5afd1ce`; `run_status=completed`; `execution_mode=real_semantic`; provider=`qwen3.6` at the approved endpoint; credential=`environment-only`; calls=`15/15`.
...
- T014: `apply/evidence/T014.final-regression-task2b-provider-repair-v9-20260812.txt` records Task 1=`49 passed`, consumers=`264 passed, 2 skipped`, full=`518 passed, 3 skipped`, and `git diff --check` pass; routing=`apply/evidence/T014.test-routing-task2b-provider-repair-v9-20260812.json`.
