...
- **Input**：当前 root `decision-log.md`、`specs/archive/task2b-knowledge-publication-body-compiler-current-draft/spec.md`、`specs/archive/task2b-knowledge-publication-body-compiler-current-draft/plan.md`；同目录 `decision-log.md` 是只读旧 receipt，不是执行依据。
