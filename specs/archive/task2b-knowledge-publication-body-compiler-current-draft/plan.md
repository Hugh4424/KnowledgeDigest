...
- T013 current evidence=`docs/archive/apply/evidence/T013.semantic-run-task2b-provider-repair-v9-20260812.json`; run_id=`run-519d5c93591e45faab8e3ef56601a3f1`; sha256=`c38aad3185bd534ee988766d55fc26ee68d5f8b2688f8e00ddb72d23dbbd17e4`; canonical validator=`valid=true`、`machine_exit_passed=true`。
...
- T014 current evidence=`docs/archive/apply/evidence/T014.final-regression-task2b-provider-repair-v9-20260812.txt`；Task 1=`49 passed`、consumer=`264 passed, 2 skipped`、full=`518 passed, 3 skipped`、`git diff --check` pass。
